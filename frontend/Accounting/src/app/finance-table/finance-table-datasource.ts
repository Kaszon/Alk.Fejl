...
/**
 * Data source for the FinanceTable view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class FinanceTableDataSource extends DataSource<FinanceTableItem> {
  data: FinanceTableItem[] = EXAMPLE_DATA;
   ...
   */
  connect(): Observable<FinanceTableItem[]> {
   ...
   */
  private getPagedData(data: FinanceTableItem[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: FinanceTableItem[]) {
